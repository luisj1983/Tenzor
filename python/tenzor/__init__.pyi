...
class Variable(Tensor):
    """Tensor with automatic differentiation tracking (alias for Tensor with requires_grad=True)."""
    pass
...
# Autograd functions
def no_grad() -> Any: ...  # Context manager
def enable_grad() -> Any: ...  # Context manager
def set_grad_enabled(mode: bool) -> Any: ...  # Context manager
