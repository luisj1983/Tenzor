...
class ProcessGroup:
    ...
    RR.14: bindings live in python/bindings/bindings_distributed.cpp.  The
    methods below mirror torch.distributed semantics — `gather` and
    `all_gather` mutate the supplied `output` list in place and return None.
    """
    @property
    def rank(self) -> int: ...
    @property
    ...
    def reduce(self, tensor: Tensor, dst_rank: int, op: ReduceOp = ...) -> None: ...
    def gather(self, tensor: Tensor, output: list, dst_rank: int) -> None: ...
    def scatter(self, tensors: Sequence[Tensor], output: Tensor, src_rank: int) -> None: ...
    def all_gather(self, tensor: Tensor, output: list) -> None: ...
    def reduce_scatter(self, tensors: Sequence[Tensor], output: Tensor,
                       op: ReduceOp = ...) -> None: ...
...
class FullyShardedDataParallel:
    """FSDP wrapper — mirrors C++ binding in bindings_distributed.cpp."""
    def __init__(self, module: Any, process_group: ProcessGroup,
                 config: Optional[FSDPConfig] = None) -> None: ...
    def forward(self, input: Tensor) -> Tensor: ...
    def finalize_backward(self) -> None: ...
    def summon_full_params(self) -> None: ...
    def release_full_params(self) -> None: ...
    def total_params(self) -> int: ...
    def sharded_param_bytes(self) -> int: ...
