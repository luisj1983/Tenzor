...
class ElectraTest : public ::tenzor::testing::BackendTest {
protected:
    void SetUp() override {
...
TEST_P(ElectraTest, ConfigSmall) {
...
TEST_P(ElectraTest, ConfigLarge) {
...
TEST_P(ElectraTest, ConfigToBertConfig) {
...
TEST_P(ElectraTest, GeneratorCreation) {
    auto config = ElectraConfig::base();
    EXPECT_NO_THROW({
...
TEST_P(ElectraTest, GeneratorForward) {
    auto config = ElectraConfig::base();
...
TEST_P(ElectraTest, DiscriminatorCreation) {
    auto config = ElectraConfig::base();
    EXPECT_NO_THROW({
...
TEST_P(ElectraTest, DiscriminatorForward) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    ElectraDiscriminator discriminator(config);
    discriminator.to(device);
...
TEST_P(ElectraTest, PreTrainingCreation) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    config.generator_layers = 2;
...
TEST_P(ElectraTest, PreTrainingForward) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    config.generator_layers = 2;
    ElectraForPreTraining model(config);
...
TEST_P(ElectraTest, PreTrainingLossComputation) {
    auto config = ElectraConfig::base();
...
TEST_P(ElectraTest, MLMLossIsRealCrossEntropyAtMaskedPositions_G13) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 1;
    config.generator_layers = 1;
...
TEST_P(ElectraTest, SequenceClassificationCreation) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
...
TEST_P(ElectraTest, SequenceClassificationForward) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    int64_t num_labels = 3;
    ElectraForSequenceClassification model(config, num_labels);
...
TEST_P(ElectraTest, TokenClassificationCreation) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
...
TEST_P(ElectraTest, TokenClassificationForward) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    int64_t num_labels = 9;
    ElectraForTokenClassification model(config, num_labels);
...
TEST_P(ElectraTest, QuestionAnsweringCreation) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
...
TEST_P(ElectraTest, QuestionAnsweringForward) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    ElectraForQuestionAnswering model(config);
    model.to(device);
...
TEST_P(ElectraTest, GradientFlowSequenceClassification) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 1;
...
TEST_P(ElectraTest, GradientFlowPreTraining) {
...
TEST_P(ElectraTest, GetGeneratorDiscriminator) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    config.generator_layers = 2;
    ElectraForPreTraining model(config);
...
TEST_P(ElectraTest, DiscriminatorBertModel) {
    auto config = ElectraConfig::base();
    config.num_hidden_layers = 2;
    ElectraDiscriminator discriminator(config);
    discriminator.to(device);
...
TEST_P(ElectraTest, AllTokensUsedForTraining) {
...
TEST_P(ElectraTest, DISABLED_BenchmarkInference) {
...
INSTANTIATE_BACKEND_TESTS(ElectraTest);
