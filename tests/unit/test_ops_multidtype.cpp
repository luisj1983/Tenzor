...
class OpsMultiDTypeTest : public MultiBackendDTypeTest {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        STANDARD_BACKENDS,
        ::testing::Values(DType::Float32, DType::Float64, DType::Float16, DType::Int32, DType::Int64, DType::Int8, DType::UInt8, DType::Bool)
    ),
