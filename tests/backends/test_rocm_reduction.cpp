...
TEST_F(ROCmReductionTest, SumFullReduction) {
    ...
    Tensor cpu_tensor({2, 3}, DType::Float32, Device::cpu());
...
TEST_F(ROCmReductionTest, MeanFullReduction) {
    ...
    Tensor result = mean(rocm_tensor);
...
TEST_F(ROCmReductionTest, SumAlongDimension) {
    ...
    Tensor result = sum(rocm_tensor, 0);
    Tensor cpu_result = result.to(Device::cpu());
    ...
    result = sum(rocm_tensor, 1);
    cpu_result = result.to(Device::cpu());
...
TEST_F(ROCmReductionTest, MeanAlongDimension) {
    ...
    Tensor result = mean(rocm_tensor, 0);
    Tensor cpu_result = result.to(Device::cpu());
...
TEST_F(ROCmReductionTest, MaxAlongDimension) {
    ...
    Tensor result = max(rocm_tensor, 0);
    Tensor cpu_result = result.to(Device::cpu());
...
TEST_F(ROCmReductionTest, MinAlongDimension) {
    ...
    Tensor result = min(rocm_tensor, 0);
    Tensor cpu_result = result.to(Device::cpu());
...
TEST_F(ROCmReductionTest, SumKeepDim) {
    ...
    Tensor result = sum(rocm_tensor, 0, true);
...
TEST_F(ROCmReductionTest, LargeTensorSum) {
    ...
    Tensor cpu_tensor({n}, DType::Float32, Device::cpu());
    std::copy(data.begin(), data.end(), cpu_tensor.data<float>());
...
TEST_F(ROCmReductionTest, SumFloat64) {
    ...
    Tensor cpu_tensor({2, 3}, DType::Float64, Device::cpu());
...
TEST_F(ROCmReductionTest, SumInt32) {
    ...
    Tensor cpu_tensor({2, 3}, DType::Int32, Device::cpu());
