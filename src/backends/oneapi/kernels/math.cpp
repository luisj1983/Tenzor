...
struct MulKernelInt8 {};
struct MulKernelUInt8 {};
struct MulKernelInt16 {};
struct MulKernelUInt16 {};
...
struct DivKernelInt8 {};
struct DivKernelInt16 {};
struct DivKernelInt64 {};
struct DivKernelUInt8 {};
struct DivKernelUInt16 {};
struct DivKernelUInt32 {};
struct DivKernelUInt64 {};
...
struct WhereKernelByte1 {};
struct WhereKernelByte2 {};
struct WhereKernelByte4 {};
struct WhereKernelByte8 {};
...
// Broadcast kernel-name tags for elementwise binary math ops that must
// broadcast like add/sub/mul/div (parity with the CPU reference, which
// routes these through compute_broadcast_shape + broadcast_op).
struct BroadcastMinimumFloat32 {};
struct BroadcastMinimumFloat64 {};
struct BroadcastMinimumFloat16 {};
struct BroadcastMinimumBFloat16 {};
struct BroadcastMaximumFloat32 {};
struct BroadcastMaximumFloat64 {};
struct BroadcastMaximumFloat16 {};
struct BroadcastMaximumBFloat16 {};
struct BroadcastFmodFloat32 {};
struct BroadcastFmodFloat64 {};
struct BroadcastFmodFloat16 {};
struct BroadcastFmodBFloat16 {};
struct BroadcastRemainderFloat32 {};
struct BroadcastRemainderFloat64 {};
struct BroadcastRemainderFloat16 {};
struct BroadcastRemainderBFloat16 {};
struct BroadcastAtan2Float32 {};
struct BroadcastAtan2Float64 {};
struct BroadcastAtan2Float16 {};
struct BroadcastAtan2BFloat16 {};
struct BroadcastHypotFloat32 {};
struct BroadcastHypotFloat64 {};
struct BroadcastHypotFloat16 {};
struct BroadcastHypotBFloat16 {};
struct BroadcastCopysignFloat32 {};
struct BroadcastCopysignFloat64 {};
struct BroadcastCopysignFloat16 {};
struct BroadcastCopysignBFloat16 {};
struct BroadcastNextafterFloat32 {};
struct BroadcastNextafterFloat64 {};
struct BroadcastNextafterFloat16 {};
struct BroadcastNextafterBFloat16 {};
...
auto mul_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (a_cont.dtype() == DType::Float32) {
        ...
        // Two's-complement wrap on overflow (PyTorch-compatible): compute in
        // int and narrow back to int8 (well-defined modulo-2^8 since C++20).
        queue.parallel_for<MulKernelInt8>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = static_cast<int8_t>(
                static_cast<int>(a_ptr[idx]) * static_cast<int>(b_ptr[idx]));
        }).wait();
    }
    else if (a_cont.dtype() == DType::UInt8) {
        const uint8_t* a_ptr = get_data_ptr<const uint8_t>(a_cont);
        ...
        queue.parallel_for<MulKernelUInt8>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = static_cast<uint8_t>(
                static_cast<unsigned>(a_ptr[idx]) * static_cast<unsigned>(b_ptr[idx]));
        }).wait();
    }
    else if (a_cont.dtype() == DType::Int16) {
        const int16_t* a_ptr = get_data_ptr<const int16_t>(a_cont);
        const int16_t* b_ptr = get_data_ptr<const int16_t>(b_cont);
        int16_t* out_ptr = get_data_ptr<int16_t>(output);

        queue.parallel_for<MulKernelInt16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = static_cast<int16_t>(
                static_cast<int>(a_ptr[idx]) * static_cast<int>(b_ptr[idx]));
        }).wait();
    }
        ...
        queue.parallel_for<MulKernelUInt16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = static_cast<uint16_t>(
                static_cast<unsigned>(a_ptr[idx]) * static_cast<unsigned>(b_ptr[idx]));
        }).wait();
    }
    else if (a_cont.dtype() == DType::Bool) {
...
auto div_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (a_cont.dtype() == DType::Float32) {
        ...
        const int8_t* b_ptr = get_data_ptr<const int8_t>(b_cont);
        int8_t* out_ptr = get_data_ptr<int8_t>(output);
        queue.parallel_for<DivKernelInt8>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            int8_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? static_cast<int8_t>(a_ptr[idx] / y) : int8_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::Int16) {
        const int16_t* a_ptr = get_data_ptr<const int16_t>(a_cont);
        const int16_t* b_ptr = get_data_ptr<const int16_t>(b_cont);
        int16_t* out_ptr = get_data_ptr<int16_t>(output);
        queue.parallel_for<DivKernelInt16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            int16_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? static_cast<int16_t>(a_ptr[idx] / y) : int16_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::Int64) {
        const int64_t* a_ptr = get_data_ptr<const int64_t>(a_cont);
        const int64_t* b_ptr = get_data_ptr<const int64_t>(b_cont);
        int64_t* out_ptr = get_data_ptr<int64_t>(output);
        queue.parallel_for<DivKernelInt64>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            int64_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? a_ptr[idx] / y : int64_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::UInt8) {
        const uint8_t* a_ptr = get_data_ptr<const uint8_t>(a_cont);
        const uint8_t* b_ptr = get_data_ptr<const uint8_t>(b_cont);
        uint8_t* out_ptr = get_data_ptr<uint8_t>(output);
        queue.parallel_for<DivKernelUInt8>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            uint8_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? static_cast<uint8_t>(a_ptr[idx] / y) : uint8_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::UInt16) {
        const uint16_t* a_ptr = get_data_ptr<const uint16_t>(a_cont);
        const uint16_t* b_ptr = get_data_ptr<const uint16_t>(b_cont);
        uint16_t* out_ptr = get_data_ptr<uint16_t>(output);
        queue.parallel_for<DivKernelUInt16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            uint16_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? static_cast<uint16_t>(a_ptr[idx] / y) : uint16_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::UInt32) {
        const uint32_t* a_ptr = get_data_ptr<const uint32_t>(a_cont);
        const uint32_t* b_ptr = get_data_ptr<const uint32_t>(b_cont);
        uint32_t* out_ptr = get_data_ptr<uint32_t>(output);
        queue.parallel_for<DivKernelUInt32>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            uint32_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? a_ptr[idx] / y : uint32_t(0);
        }).wait();
    }
    else if (a_cont.dtype() == DType::UInt64) {
        const uint64_t* a_ptr = get_data_ptr<const uint64_t>(a_cont);
        const uint64_t* b_ptr = get_data_ptr<const uint64_t>(b_cont);
        uint64_t* out_ptr = get_data_ptr<uint64_t>(output);
        queue.parallel_for<DivKernelUInt64>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            uint64_t y = b_ptr[idx];
            out_ptr[idx] = y != 0 ? a_ptr[idx] / y : uint64_t(0);
        }).wait();
    }
    else {
...
auto matmul_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (a_shape.size() == 1 && b_shape.size() == 2) {
        ...
        if (a_cont.dtype() == DType::Float32) {
            ...
            // Float16 I/O with Float32 accumulation (same pattern as BF16).
            const sycl::half* a_ptr = get_data_ptr<const sycl::half>(a_cont);
            const sycl::half* b_ptr = get_data_ptr<const sycl::half>(b_cont);
            sycl::half* out_ptr = get_data_ptr<sycl::half>(output);

            queue.parallel_for<class MatMulVecFloat16>(sycl::range<1>(m), [=](sycl::id<1> idx) {
                const int64_t j = idx[0];
                float sum = 0.0f;
                for (int64_t p = 0; p < n; ++p) {
    ...
    if (a_cont.dtype() == DType::Float32) {
        ...
        queue.parallel_for<MatMulKernelInt32>(sycl::range<3>(batch_count, m, n), [=](sycl::id<3> idx) {
            ...
            out_ptr[bi * cs + i * n + j] = static_cast<int32_t>(sum);
             ...
             a_cont.dtype() == DType::Int64 || a_cont.dtype() == DType::UInt8 ||
        ...
        switch (a_cont.dtype()) {
            case DType::Int8:   run_t.template operator()<int8_t>();   break;
            case DType::Int16:  run_t.template operator()<int16_t>();  break;
            case DType::Int64:  run_t.template operator()<int64_t>();  break;
            case DType::UInt8:  run_t.template operator()<uint8_t>();  break;
            case DType::UInt16: run_t.template operator()<uint16_t>(); break;
            case DType::UInt32: run_t.template operator()<uint32_t>(); break;
            case DType::UInt64: run_t.template operator()<uint64_t>(); break;
            default: break;
        }
    }
    else if (a_cont.dtype() == DType::BFloat16) {
        ...
        // Complex matmul via oneMKL cgemm. Tenzor stores complex as interleaved
        // (real, imag) pairs, binary-compatible with std::complex<float>.
        using cf = std::complex<float>;
        const cf* a_ptr = reinterpret_cast<const cf*>(get_data_ptr<const float>(a_cont));
        const cf* b_ptr = reinterpret_cast<const cf*>(get_data_ptr<const float>(b_cont));
        cf* out_ptr = reinterpret_cast<cf*>(get_data_ptr<float>(output));

        auto deleter = [&queue](cf* p) { sycl::free(p, queue); };
        std::unique_ptr<cf, decltype(deleter)> d_a(
            static_cast<cf*>(sycl::malloc_device(m * k * sizeof(cf), queue)), deleter);
        std::unique_ptr<cf, decltype(deleter)> d_b(
            static_cast<cf*>(sycl::malloc_device(k * n * sizeof(cf), queue)), deleter);
        std::unique_ptr<cf, decltype(deleter)> d_c(
            static_cast<cf*>(sycl::malloc_device(m * n * sizeof(cf), queue)), deleter);

        const cf alpha{1.0f, 0.0f};
        const cf beta{0.0f, 0.0f};
        for (int64_t bi = 0; bi < batch_count; ++bi) {
            queue.memcpy(d_a.get(), a_ptr + bi * a_batch_stride, m * k * sizeof(cf));
            queue.memcpy(d_b.get(), b_ptr + bi * b_batch_stride, k * n * sizeof(cf));
            try {
                ::oneapi::mkl::blas::column_major::gemm(
                    queue,
                    ::oneapi::mkl::transpose::nontrans,
                ...
                throw std::runtime_error(std::string("oneMKL GEMM (C64) failed: ") + e.what());
            } catch (const sycl::exception& e) {
                throw std::runtime_error(std::string("SYCL error in GEMM (C64): ") + e.what());
            }
            queue.memcpy(out_ptr + bi * c_batch_stride, d_c.get(), m * n * sizeof(cf));
        }
        queue.wait_and_throw();
    }
    else if (a_cont.dtype() == DType::Complex128) {
        using cd = std::complex<double>;
        const cd* a_ptr = reinterpret_cast<const cd*>(get_data_ptr<const double>(a_cont));
        const cd* b_ptr = reinterpret_cast<const cd*>(get_data_ptr<const double>(b_cont));
        cd* out_ptr = reinterpret_cast<cd*>(get_data_ptr<double>(output));

        auto deleter = [&queue](cd* p) { sycl::free(p, queue); };
        std::unique_ptr<cd, decltype(deleter)> d_a(
            static_cast<cd*>(sycl::malloc_device(m * k * sizeof(cd), queue)), deleter);
        std::unique_ptr<cd, decltype(deleter)> d_b(
            static_cast<cd*>(sycl::malloc_device(k * n * sizeof(cd), queue)), deleter);
        std::unique_ptr<cd, decltype(deleter)> d_c(
            static_cast<cd*>(sycl::malloc_device(m * n * sizeof(cd), queue)), deleter);

        const cd alpha{1.0, 0.0};
        const cd beta{0.0, 0.0};
        for (int64_t bi = 0; bi < batch_count; ++bi) {
            queue.memcpy(d_a.get(), a_ptr + bi * a_batch_stride, m * k * sizeof(cd));
            queue.memcpy(d_b.get(), b_ptr + bi * b_batch_stride, k * n * sizeof(cd));
            try {
                ::oneapi::mkl::blas::column_major::gemm(
                    queue,
                    ::oneapi::mkl::transpose::nontrans,
                ...
                throw std::runtime_error(std::string("oneMKL GEMM (C128) failed: ") + e.what());
            } catch (const sycl::exception& e) {
                throw std::runtime_error(std::string("SYCL error in GEMM (C128): ") + e.what());
            }
            queue.memcpy(out_ptr + bi * c_batch_stride, d_c.get(), m * n * sizeof(cd));
        }
        queue.wait_and_throw();
    }
    else {
...
auto bmm_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (a_cont.dtype() == DType::Float32) {
        ...
        queue.parallel_for<BmmKernelBFloat16>(sycl::range<3>(batch_size, M, N),
            [=](sycl::id<3> idx) {
             ...
             a_cont.dtype() == DType::Int32 || a_cont.dtype() == DType::Int64 ||
             a_cont.dtype() == DType::UInt8 || a_cont.dtype() == DType::UInt16 ||
             a_cont.dtype() == DType::UInt32 || a_cont.dtype() == DType::UInt64) {
        const int64_t bs = batch_size, MM = M, NN = N, KK = K;
        auto run_t = [&]<typename T>() {
            const T* a_ptr = get_data_ptr<const T>(a_cont);
            const T* b_ptr = get_data_ptr<const T>(b_cont);
            T* out_ptr = get_data_ptr<T>(output);
            using ACC = std::conditional_t<std::is_signed_v<T>, long long, unsigned long long>;
            queue.parallel_for(sycl::range<3>(bs, MM, NN), [=](sycl::id<3> idx) {
                const int64_t batch = idx[0], i = idx[1], j = idx[2];
                const int64_t ao = batch * MM * KK, bo = batch * KK * NN, oo = batch * MM * NN;
                ACC sum = 0;
                for (int64_t p = 0; p < KK; ++p)
                    sum += static_cast<ACC>(a_ptr[ao + i * KK + p]) * static_cast<ACC>(b_ptr[bo + p * NN + j]);
                out_ptr[oo + i * NN + j] = static_cast<T>(sum);
            }).wait();
        };
        switch (a_cont.dtype()) {
            case DType::Int8:   run_t.template operator()<int8_t>();   break;
            case DType::Int16:  run_t.template operator()<int16_t>();  break;
            case DType::Int32:  run_t.template operator()<int32_t>();  break;
            case DType::Int64:  run_t.template operator()<int64_t>();  break;
            case DType::UInt8:  run_t.template operator()<uint8_t>();  break;
            case DType::UInt16: run_t.template operator()<uint16_t>(); break;
            case DType::UInt32: run_t.template operator()<uint32_t>(); break;
    ...
    else if (a_cont.dtype() == DType::Complex64 || a_cont.dtype() == DType::Complex128) {
        const int64_t bs = batch_size, MM = M, NN = N, KK = K;
        auto run_c = [&]<typename R>() {
            const R* a_ptr = get_data_ptr<const R>(a_cont);
            const R* b_ptr = get_data_ptr<const R>(b_cont);
            ...
            queue.parallel_for(sycl::range<3>(bs, MM, NN), [=](sycl::id<3> idx) {
                ...
                R sre = R(0), sim = R(0);
                for (int64_t p = 0; p < KK; ++p) {
                    const int64_t ai = (ao + i * KK + p) * 2;
                    const int64_t bi = (bo + p * NN + j) * 2;
                    R ar = a_ptr[ai], aim = a_ptr[ai + 1];
                    R br = b_ptr[bi], bim = b_ptr[bi + 1];
                    sre += ar * br - aim * bim;
                    sim += ar * bim + aim * br;
                }
                const int64_t out_idx = (oo + i * NN + j) * 2;
                out_ptr[out_idx] = sre;
                out_ptr[out_idx + 1] = sim;
            }).wait();
        };
        if (a_cont.dtype() == DType::Complex64) run_c.template operator()<float>();
...
// Square root kernel
auto sqrt_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    ...
    // own binary-op guards (a.is_contiguous() ? a : contiguous_kernel(a, queue))
...
// Negation kernel
auto neg_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard (neg_kernel/
    // sqrt_kernel there) and this file's own binary-op guards
    // (a.is_contiguous() ? a : contiguous_kernel(a, queue), used throughout
    // this file for two-operand ops) -- this exact guard was simply missing
    // for the unary math kernels.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
                  input.dtype(), input.device());
...
auto abs_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto log_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Exponential kernel
auto exp_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Power kernel
auto pow_kernel(const Tensor& input_in, double exponent, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    const float exponent_f = static_cast<float>(exponent);
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
                  input.dtype(), input.device());
    ...
    if (input.dtype() == DType::Float32) {
        ...
        queue.parallel_for<PowKernelFloat32>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = sycl::pow(in_ptr[idx], exponent_f);
        }).wait();
    }
    else if (input.dtype() == DType::Float64) {
        const double* in_ptr = get_data_ptr<const double>(input);
        ...
        queue.parallel_for<PowKernelFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            ...
            out_ptr[idx] = sycl::half(sycl::pow(val, exponent_f));
        }).wait();
    }
    else if (input.dtype() == DType::BFloat16) {
        const uint16_t* in_ptr = get_data_ptr<const uint16_t>(input);
        ...
        queue.parallel_for<PowKernelBFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = f32_to_bf16(sycl::pow(bf16_to_f32(in_ptr[idx]), exponent_f));
        }).wait();
    }
    else {
...
auto dot_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (a.dtype() == DType::Float16 || a.dtype() == DType::BFloat16) {
        Tensor r = dot_kernel(a.to(DType::Float32), b.to(DType::Float32), queue);
        return r.to(a.dtype());
    }
    ...
    if (a.dtype() == DType::Complex64 || a.dtype() == DType::Complex128) {
        // Complex dot: sum_i a[i]*b[i] (no conjugation), via separate real/imag
        // reductions over the interleaved (re, im) storage.
        auto run_c = [&]<typename R>() {
            const R* a_data = reinterpret_cast<const R*>(get_data_ptr<const R>(a));
            const R* b_data = reinterpret_cast<const R*>(get_data_ptr<const R>(b));
            R* out_ptr = reinterpret_cast<R*>(get_data_ptr<R>(output));
            ...
            queue.parallel_for(sycl::range<1>(n),
                               ...
                               [=](auto i, auto& re_s, auto& im_s) {
                const int64_t base = i[0] * 2;
                R ar = a_data[base], ai = a_data[base + 1];
                R br = b_data[base], bi = b_data[base + 1];
                re_s += ar * br - ai * bi;
                im_s += ar * bi + ai * br;
            }).wait();
            queue.wait_and_throw();
        ...
        if (a.dtype() == DType::Complex64) run_c.template operator()<float>();
        else run_c.template operator()<double>();
        return output;
    }
    ...
    else if (a.dtype() == DType::Int8 || a.dtype() == DType::Int16 ||
             a.dtype() == DType::Int32 || a.dtype() == DType::Int64 ||
             a.dtype() == DType::UInt8 || a.dtype() == DType::UInt16 ||
             a.dtype() == DType::UInt32 || a.dtype() == DType::UInt64) {
        auto run_t = [&]<typename T>() {
            const T* a_data = get_data_ptr<const T>(a);
            const T* b_data = get_data_ptr<const T>(b);
            T* out_ptr = get_data_ptr<T>(output);
            auto sum_buf = sycl::malloc_shared<T>(1, queue);
            sum_buf[0] = T(0);
            queue.parallel_for(sycl::range<1>(n), sycl::reduction(sum_buf, sycl::plus<T>()),
                              [=](auto i, auto& s) {
                s += static_cast<T>(a_data[i[0]] * b_data[i[0]]);
            }).wait();
            queue.wait_and_throw();
            out_ptr[0] = sum_buf[0];
            sycl::free(sum_buf, queue);
...
// Sine kernel
auto sin_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Cosine kernel
auto cos_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Tangent kernel
auto tan_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Arc sine kernel
auto asin_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Arc cosine kernel
auto acos_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Arc tangent kernel
auto atan_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto sinh_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto cosh_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto atan2_kernel(const Tensor& y, const Tensor& x, sycl::queue& queue) -> Tensor {
    ...
    Tensor y_cont = y.is_contiguous() ? y : contiguous_kernel(y, queue);
    Tensor x_cont = x.is_contiguous() ? x : contiguous_kernel(x, queue);
    auto y_shape = y_cont.shape();
    auto x_shape = x_cont.shape();
    bool same_shape = std::equal(y_shape.begin(), y_shape.end(), x_shape.begin(), x_shape.end());

    if (!same_shape) {
        auto out_shape = broadcast_shapes(y_shape, x_shape);
        auto info = compute_broadcast_info(y_shape, x_shape, out_shape);
        Tensor output(out_shape, y_cont.dtype(), y_cont.device());
        if (y_cont.dtype() == DType::Float32) {
            sycl_broadcast_binary<float, BroadcastAtan2Float32>(
                y_cont, x_cont, output, info, queue,
                [](float a, float b) { return sycl::atan2(a, b); });
        } else if (y_cont.dtype() == DType::Float64) {
            sycl_broadcast_binary<double, BroadcastAtan2Float64>(
                y_cont, x_cont, output, info, queue,
                [](double a, double b) { return sycl::atan2(a, b); });
        } else if (y_cont.dtype() == DType::Float16) {
            sycl_broadcast_binary<sycl::half, BroadcastAtan2Float16>(
                y_cont, x_cont, output, info, queue,
                [](sycl::half a, sycl::half b) {
                    return sycl::half(sycl::atan2(static_cast<float>(a), static_cast<float>(b)));
                });
        } else if (y_cont.dtype() == DType::BFloat16) {
            sycl_broadcast_binary<uint16_t, BroadcastAtan2BFloat16>(
                y_cont, x_cont, output, info, queue,
                [](uint16_t a, uint16_t b) {
                    return f32_to_bf16(sycl::atan2(bf16_to_f32(a), bf16_to_f32(b)));
                });
        } else {
    ...
    Tensor output(std::vector<int64_t>(y_cont.shape().begin(), y_cont.shape().end()),
                  y_cont.dtype(), y_cont.device());

    const int64_t numel = y_cont.numel();

    if (y_cont.dtype() == DType::Float32) {
        const float* y_ptr = get_data_ptr<const float>(y_cont);
        const float* x_ptr = get_data_ptr<const float>(x_cont);
        float* out_ptr = get_data_ptr<float>(output);
        ...
        const double* y_ptr = get_data_ptr<const double>(y_cont);
        const double* x_ptr = get_data_ptr<const double>(x_cont);
        double* out_ptr = get_data_ptr<double>(output);
        ...
        const sycl::half* y_ptr = get_data_ptr<const sycl::half>(y_cont);
        const sycl::half* x_ptr = get_data_ptr<const sycl::half>(x_cont);
        sycl::half* out_ptr = get_data_ptr<sycl::half>(output);
        ...
        const uint16_t* y_ptr = get_data_ptr<const uint16_t>(y_cont);
        const uint16_t* x_ptr = get_data_ptr<const uint16_t>(x_cont);
        uint16_t* out_ptr = get_data_ptr<uint16_t>(output);
...
// Round kernel
auto round_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Floor kernel
auto floor_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Ceil kernel
auto ceil_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Trunc kernel
auto trunc_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Reciprocal kernel
auto reciprocal_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
// Clamp min kernel
auto clamp_min_kernel(const Tensor& input_in, double min_val, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    ...
    if (input.dtype() == DType::Float32) {
        ...
        queue.parallel_for<ClampMinKernelFloat32>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = sycl::fmax(in_ptr[idx], min_val_f);
        }).wait();
    }
    else if (input.dtype() == DType::Float64) {
        const double* in_ptr = get_data_ptr<const double>(input);
        ...
        queue.parallel_for<ClampMinKernelFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = sycl::half(sycl::fmax(static_cast<float>(in_ptr[idx]), min_val_f));
        }).wait();
    }
    else if (input.dtype() == DType::BFloat16) {
        const uint16_t* in_ptr = get_data_ptr<const uint16_t>(input);
        ...
        queue.parallel_for<ClampMinKernelBFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = f32_to_bf16(sycl::fmax(bf16_to_f32(in_ptr[idx]), min_val_f));
        }).wait();
    }
    else {
        auto run = [&]<typename T>() {
...
// Clamp max kernel
auto clamp_max_kernel(const Tensor& input_in, double max_val, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    ...
    if (input.dtype() == DType::Float32) {
        ...
        queue.parallel_for<ClampMaxKernelFloat32>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = sycl::fmin(in_ptr[idx], max_val_f);
        }).wait();
    }
    else if (input.dtype() == DType::Float64) {
        const double* in_ptr = get_data_ptr<const double>(input);
        ...
        queue.parallel_for<ClampMaxKernelFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = sycl::half(sycl::fmin(static_cast<float>(in_ptr[idx]), max_val_f));
        }).wait();
    }
    else if (input.dtype() == DType::BFloat16) {
        const uint16_t* in_ptr = get_data_ptr<const uint16_t>(input);
        ...
        queue.parallel_for<ClampMaxKernelBFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            out_ptr[idx] = f32_to_bf16(sycl::fmin(bf16_to_f32(in_ptr[idx]), max_val_f));
        }).wait();
    }
    else {
        auto run = [&]<typename T>() {
...
auto where_kernel(const Tensor& condition_in, const Tensor& x_in, const Tensor& y_in, sycl::queue& queue) -> Tensor {
    ...
    if (x.dtype() == DType::Float32) {
        ...
        // Generic fallback for the remaining integer / bool dtypes (Int8/Int16/
        // Int32/UInt8/UInt16/UInt32/UInt64/Bool). where() is a conditional
        // element copy independent of the numeric interpretation, so dispatch by
        // element byte-size using an unsigned integer of matching width.
        const size_t esz = dtype_size(x.dtype());
        const bool* cond_ptr = get_data_ptr<const bool>(condition);
        const uint8_t* x_bytes = static_cast<const uint8_t*>(x.data_ptr());
        const uint8_t* y_bytes = static_cast<const uint8_t*>(y.data_ptr());
        uint8_t* out_bytes = static_cast<uint8_t*>(output.data_ptr());
        if (esz == 1) {
            queue.parallel_for<WhereKernelByte1>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
                out_bytes[idx] = cond_ptr[idx] ? x_bytes[idx] : y_bytes[idx];
            }).wait();
        } else if (esz == 2) {
            const uint16_t* xp = reinterpret_cast<const uint16_t*>(x_bytes);
            const uint16_t* yp = reinterpret_cast<const uint16_t*>(y_bytes);
            uint16_t* op = reinterpret_cast<uint16_t*>(out_bytes);
            queue.parallel_for<WhereKernelByte2>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
                op[idx] = cond_ptr[idx] ? xp[idx] : yp[idx];
            }).wait();
        } else if (esz == 4) {
            const uint32_t* xp = reinterpret_cast<const uint32_t*>(x_bytes);
            const uint32_t* yp = reinterpret_cast<const uint32_t*>(y_bytes);
            uint32_t* op = reinterpret_cast<uint32_t*>(out_bytes);
            queue.parallel_for<WhereKernelByte4>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
                op[idx] = cond_ptr[idx] ? xp[idx] : yp[idx];
            }).wait();
        } else if (esz == 8) {
            const uint64_t* xp = reinterpret_cast<const uint64_t*>(x_bytes);
            const uint64_t* yp = reinterpret_cast<const uint64_t*>(y_bytes);
            uint64_t* op = reinterpret_cast<uint64_t*>(out_bytes);
            queue.parallel_for<WhereKernelByte8>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
                op[idx] = cond_ptr[idx] ? xp[idx] : yp[idx];
            }).wait();
        } else {
...
struct AddInplaceKernelInt32 {};
struct AddInplaceKernelInt64 {};
struct AddInplaceBcastKernelInt32 {};
struct AddInplaceBcastKernelInt64 {};
...
auto add_inplace_kernel(Tensor& inout, const Tensor& other, sycl::queue& queue) -> Tensor {
    ...
    if (!same_shape) {
        ...
        if (inout.dtype() == DType::Float32) {
            ...
            int32_t* data = get_data_ptr<int32_t>(inout);
            const int32_t* other_ptr = get_data_ptr<const int32_t>(other);
            queue.parallel_for<AddInplaceBcastKernelInt32>(sycl::range<1>(n), [=](sycl::id<1> idx) {
                data[idx] += other_ptr[broadcast_other_idx(idx, bs)];
            });
        } else if (inout.dtype() == DType::Int64) {
            int64_t* data = get_data_ptr<int64_t>(inout);
            const int64_t* other_ptr = get_data_ptr<const int64_t>(other);
            queue.parallel_for<AddInplaceBcastKernelInt64>(sycl::range<1>(n), [=](sycl::id<1> idx) {
                data[idx] += other_ptr[broadcast_other_idx(idx, bs)];
            });
        } else {
    ...
    if (inout.dtype() == DType::Float32) {
        ...
        int32_t* data = get_data_ptr<int32_t>(inout);
        const int32_t* other_ptr = get_data_ptr<const int32_t>(other);
        queue.parallel_for<AddInplaceKernelInt32>(sycl::range<1>(n), [=](sycl::id<1> idx) {
            data[idx] += other_ptr[idx];
        }).wait();
    } else if (inout.dtype() == DType::Int64) {
        int64_t* data = get_data_ptr<int64_t>(inout);
        const int64_t* other_ptr = get_data_ptr<const int64_t>(other);
        queue.parallel_for<AddInplaceKernelInt64>(sycl::range<1>(n), [=](sycl::id<1> idx) {
            data[idx] += other_ptr[idx];
        }).wait();
    } else {
        throw std::runtime_error("add_inplace: unsupported dtype");
...
auto has_inf_nan_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto cumsum_kernel(const Tensor& input_raw, int64_t dim, sycl::queue& queue) -> Tensor {
    ...
    //
    // Float16/BFloat16: widen to Float32, scan, narrow back (parity with the
    // CPU reference cumsum_kernel, which has no native half-precision scan).
    if (input_raw.dtype() == DType::Float16 || input_raw.dtype() == DType::BFloat16) {
        DType orig_dtype = input_raw.dtype();
        Tensor widened = cumsum_kernel(input_raw.to(DType::Float32), dim, queue);
        return widened.to(orig_dtype);
    }
...
auto log2_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto log10_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto log1p_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto exp2_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto expm1_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto erf_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto erfc_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto isnan_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto isinf_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto isfinite_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: get_data_ptr() is a raw pointer cast with NO stride handling
    // -- a non-contiguous input (e.g. the result of narrow/slice/transpose)
    // silently reads the wrong elements via straight linear indexing.
    // Mirrors the CPU backend's identical contiguity guard and this file's
...
auto fmod_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (!same_shape) {
        ...
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
        if (a_cont.dtype() == DType::Float32) {
            sycl_broadcast_binary<float, BroadcastFmodFloat32>(
                a_cont, b_cont, output, info, queue,
                [](float x, float y) { return sycl::fmod(x, y); });
        } else if (a_cont.dtype() == DType::Float64) {
            sycl_broadcast_binary<double, BroadcastFmodFloat64>(
                a_cont, b_cont, output, info, queue,
                [](double x, double y) { return sycl::fmod(x, y); });
        } else if (a_cont.dtype() == DType::Float16) {
            sycl_broadcast_binary<sycl::half, BroadcastFmodFloat16>(
                a_cont, b_cont, output, info, queue,
                [](sycl::half x, sycl::half y) {
                    return sycl::half(sycl::fmod(static_cast<float>(x), static_cast<float>(y)));
                });
        } else if (a_cont.dtype() == DType::BFloat16) {
            sycl_broadcast_binary<uint16_t, BroadcastFmodBFloat16>(
                a_cont, b_cont, output, info, queue,
                [](uint16_t x, uint16_t y) {
                    return f32_to_bf16(sycl::fmod(bf16_to_f32(x), bf16_to_f32(y)));
                });
        } else {
...
auto lerp_kernel(const Tensor& start, const Tensor& end, const Tensor& weight, sycl::queue& queue) -> Tensor {
    ...
    // Mirror the CPU reference contract: start and end share the output shape
    // (indexed element-wise), while weight is either a scalar (numel()==1,
    // broadcast to every element) or the same shape as start (indexed
    // element-wise). Ensure inputs are contiguous so flat indexing is valid.
    Tensor s_cont = start.is_contiguous() ? start : contiguous_kernel(start, queue);
    Tensor e_cont = end.is_contiguous() ? end : contiguous_kernel(end, queue);
    Tensor w_cont = weight.is_contiguous() ? weight : contiguous_kernel(weight, queue);

    const bool scalar_w = (w_cont.numel() == 1);

    Tensor output(std::vector<int64_t>(s_cont.shape().begin(), s_cont.shape().end()),
                  s_cont.dtype(), s_cont.device());
    const int64_t numel = s_cont.numel();

    if (s_cont.dtype() == DType::Float32) {
        const float* s_ptr = get_data_ptr<const float>(s_cont);
        const float* e_ptr = get_data_ptr<const float>(e_cont);
        const float* w_ptr = get_data_ptr<const float>(w_cont);
        float* out_ptr = get_data_ptr<float>(output);
        queue.parallel_for<LerpKernelFloat32>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            float w = scalar_w ? w_ptr[0] : w_ptr[idx];
            out_ptr[idx] = s_ptr[idx] + w * (e_ptr[idx] - s_ptr[idx]);
        }).wait();
    } else if (s_cont.dtype() == DType::Float64) {
        const double* s_ptr = get_data_ptr<const double>(s_cont);
        const double* e_ptr = get_data_ptr<const double>(e_cont);
        const double* w_ptr = get_data_ptr<const double>(w_cont);
        double* out_ptr = get_data_ptr<double>(output);
        queue.parallel_for<LerpKernelFloat64>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            double w = scalar_w ? w_ptr[0] : w_ptr[idx];
            out_ptr[idx] = s_ptr[idx] + w * (e_ptr[idx] - s_ptr[idx]);
        }).wait();
    } else if (s_cont.dtype() == DType::Float16) {
        const sycl::half* s_ptr = get_data_ptr<const sycl::half>(s_cont);
        const sycl::half* e_ptr = get_data_ptr<const sycl::half>(e_cont);
        ...
        queue.parallel_for<LerpKernelFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            ...
            float w = static_cast<float>(scalar_w ? w_ptr[0] : w_ptr[idx]);
            out_ptr[idx] = sycl::half(s + w * (e - s));
        }).wait();
    } else if (s_cont.dtype() == DType::BFloat16) {
        const uint16_t* s_ptr = get_data_ptr<const uint16_t>(s_cont);
        const uint16_t* e_ptr = get_data_ptr<const uint16_t>(e_cont);
        ...
        queue.parallel_for<LerpKernelBFloat16>(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            ...
            float w = bf16_to_f32(scalar_w ? w_ptr[0] : w_ptr[idx]);
...
auto logical_not_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto minimum_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    // Broadcasting path (parity with CPU minimum_kernel, which broadcasts).
    if (!same_shape) {
        auto out_shape = broadcast_shapes(a_shape, b_shape);
        auto info = compute_broadcast_info(a_shape, b_shape, out_shape);
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
...
auto maximum_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    // Broadcasting path (parity with CPU maximum_kernel, which broadcasts).
    if (!same_shape) {
        auto out_shape = broadcast_shapes(a_shape, b_shape);
        auto info = compute_broadcast_info(a_shape, b_shape, out_shape);
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
...
auto angle_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
...
auto frac_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    if (input.dtype() == DType::Float16 || input.dtype() == DType::BFloat16) {
...
auto nan_to_num_kernel(const Tensor& input_in, double nan_v, double posinf_v, double neginf_v, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    if (input.dtype() == DType::Float16 || input.dtype() == DType::BFloat16) {
...
auto log_sigmoid_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    if (input.dtype() == DType::Float16 || input.dtype() == DType::BFloat16) {
...
auto bincount_kernel(const Tensor& input, const Tensor* weights,
    ...
    // The binning kernels below read int64_t. Widen narrower integer inputs
    // once up front — previously an Int32 input was REINTERPRETED as int64_t,
    // producing garbage bin maxima and a nullptr-returning over-allocation
    // ("OneAPICachingAllocator: SYCL allocation returned nullptr").
    Tensor input64 = (input.dtype() == DType::Int64)
        ? input
        : cast_kernel(input, DType::Int64, queue);
    ...
    // PyTorch semantics: weighted bincount always returns Float64 (the CPU
    // backend does the same); unweighted returns Int64 counts.
    ...
    if (has_weights && weights->dtype() == DType::Float64) {
        ...
        // Float32 weights still accumulate into the Float64 output.
        const float* w_ptr = get_data_ptr<const float>(*weights);
        double* out_ptr = get_data_ptr<double>(output);
        queue.parallel_for(sycl::range<1>(numel), [=](sycl::id<1> idx) {
            int64_t bin = in_ptr[idx];
            double w = static_cast<double>(w_ptr[idx]);
            sycl::atomic_ref<double, sycl::memory_order::relaxed,
                              sycl::memory_scope::device,
                              sycl::access::address_space::global_space>
                atomic_bin(out_ptr[bin]);
...
auto rsqrt_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto square_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto asinh_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto acosh_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto atanh_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    Tensor output(std::vector<int64_t>(input.shape().begin(), input.shape().end()),
...
auto hypot_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (!same_shape) {
        ...
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
        if (a_cont.dtype() == DType::Float32) {
            sycl_broadcast_binary<float, BroadcastHypotFloat32>(
                a_cont, b_cont, output, info, queue,
                [](float x, float y) { return sycl::hypot(x, y); });
        } else if (a_cont.dtype() == DType::Float64) {
            sycl_broadcast_binary<double, BroadcastHypotFloat64>(
                a_cont, b_cont, output, info, queue,
                [](double x, double y) { return sycl::hypot(x, y); });
        } else if (a_cont.dtype() == DType::Float16) {
            sycl_broadcast_binary<sycl::half, BroadcastHypotFloat16>(
                a_cont, b_cont, output, info, queue,
                [](sycl::half x, sycl::half y) {
                    return sycl::half(sycl::hypot(static_cast<float>(x), static_cast<float>(y)));
                });
        } else if (a_cont.dtype() == DType::BFloat16) {
            sycl_broadcast_binary<uint16_t, BroadcastHypotBFloat16>(
                a_cont, b_cont, output, info, queue,
                [](uint16_t x, uint16_t y) {
                    return f32_to_bf16(sycl::hypot(bf16_to_f32(x), bf16_to_f32(y)));
                });
        } else {
...
auto copysign_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (!same_shape) {
        ...
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
        if (a_cont.dtype() == DType::Float32) {
            sycl_broadcast_binary<float, BroadcastCopysignFloat32>(
                a_cont, b_cont, output, info, queue,
                [](float x, float y) { return sycl::copysign(x, y); });
        } else if (a_cont.dtype() == DType::Float64) {
            sycl_broadcast_binary<double, BroadcastCopysignFloat64>(
                a_cont, b_cont, output, info, queue,
                [](double x, double y) { return sycl::copysign(x, y); });
        } else if (a_cont.dtype() == DType::Float16) {
            sycl_broadcast_binary<sycl::half, BroadcastCopysignFloat16>(
                a_cont, b_cont, output, info, queue,
                [](sycl::half x, sycl::half y) {
                    return sycl::half(sycl::copysign(static_cast<float>(x), static_cast<float>(y)));
                });
        } else if (a_cont.dtype() == DType::BFloat16) {
            sycl_broadcast_binary<uint16_t, BroadcastCopysignBFloat16>(
                a_cont, b_cont, output, info, queue,
                [](uint16_t x, uint16_t y) {
                    return f32_to_bf16(sycl::copysign(bf16_to_f32(x), bf16_to_f32(y)));
                });
        } else {
...
auto nextafter_kernel(const Tensor& a, const Tensor& b, sycl::queue& queue) -> Tensor {
    ...
    if (!same_shape) {
        ...
        Tensor output(out_shape, a_cont.dtype(), a_cont.device());
        if (a_cont.dtype() == DType::Float32) {
            sycl_broadcast_binary<float, BroadcastNextafterFloat32>(
                a_cont, b_cont, output, info, queue,
                [](float x, float y) { return sycl::nextafter(x, y); });
        } else if (a_cont.dtype() == DType::Float64) {
            sycl_broadcast_binary<double, BroadcastNextafterFloat64>(
                a_cont, b_cont, output, info, queue,
                [](double x, double y) { return sycl::nextafter(x, y); });
        } else if (a_cont.dtype() == DType::Float16) {
            sycl_broadcast_binary<sycl::half, BroadcastNextafterFloat16>(
                a_cont, b_cont, output, info, queue,
                [](sycl::half x, sycl::half y) {
                    return sycl::half(sycl::nextafter(static_cast<float>(x), static_cast<float>(y)));
                });
        } else if (a_cont.dtype() == DType::BFloat16) {
            sycl_broadcast_binary<uint16_t, BroadcastNextafterBFloat16>(
                a_cont, b_cont, output, info, queue,
                [](uint16_t x, uint16_t y) {
                    return f32_to_bf16(sycl::nextafter(bf16_to_f32(x), bf16_to_f32(y)));
                });
        } else {
...
auto deg2rad_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto rad2deg_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto logit_kernel(const Tensor& input_in, float eps, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto signbit_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto isposinf_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto isneginf_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
auto frexp_kernel(const Tensor& input_in, sycl::queue& queue) -> std::vector<Tensor> {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
...
// ============================================================================
auto diagflat_kernel(const Tensor& input_in, int64_t offset, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    // Flatten input to 1D
...
auto isreal_kernel(const Tensor& input_in, sycl::queue& queue) -> Tensor {
    // JIT-R163: see neg_kernel's identical contiguity-guard comment.
    Tensor input_cont = input_in.is_contiguous() ? input_in : contiguous_kernel(input_in, queue);
    const Tensor& input = input_cont;
    int64_t numel = input.numel();
