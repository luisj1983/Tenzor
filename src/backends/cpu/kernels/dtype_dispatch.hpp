 ...
 * @brief Template-based dtype dispatch macros for CPU kernels
 *
 * Provides AT_DISPATCH-style macros that eliminate repetitive dtype switch
 * statements. Each macro defines a `scalar_t` type alias within a lambda
 * and invokes it for the matching DType.
 *
 * Usage:
 * @code
...
// ============================================================================
// TENZOR_DISPATCH_INTEGER_TYPES — Int8, UInt8, Int32, Int64
// ============================================================================
...
// ============================================================================
// TENZOR_DISPATCH_ALL_TYPES_AND_BOOL — All types including Bool
// ============================================================================
#define TENZOR_DISPATCH_ALL_TYPES_AND_BOOL(DTYPE, NAME, ...)                    \
    [&] {                                                                       \
        switch (DTYPE) {                                                        \
            case DType::Float32: {                                              \
                using scalar_t = float;                                         \
